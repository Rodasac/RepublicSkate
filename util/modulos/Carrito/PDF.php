...
// Tabla coloreada
    ...
    function Header()
    {
        ...
        $cal->setTime(strtotime($date->format("D, d M Y H:i:s")) * 1000.);
        ...
        $this->Cell(0,1,"Fecha del reporte: ".strtoupper(utf8_decode(IntlDateFormatter::formatObject($cal, IntlDateFormatter::TRADITIONAL))),'B',0,'C');
        // Salto de línea
        $this->Ln(2);
    }
    function Footer()
